...
`bmad-build` na **Estória 5.11** (Expiração da Tentativa de Pagamento 🔒). A 5.10 está em `main` (`22500bf`), a 5.9 em `main` (`577a6aa`), a 5.8 em `main` (`e421de8`), a 5.7
em `main` (`7cd26ac`), a 5.6 em `main` (`9174f88`), a 5.5 em `main` (`f3cc0ff`), a 5.4 em `main` (`6e5984f`), a 5.3 em `main` (`dbcb2b8`) e a 5.2 em
`main` (`400861b`), as nove em `review` no `sprint-status.yaml`: falta a leitura humana
