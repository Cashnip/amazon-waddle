...
`bmad-build` na **Estória 5.2** (seleção de Endereço no checkout). A 5.1 está `done`: o commit `a454444` passou
pela leitura humana (`bmad-checkpoint-preview`) em 2026-09-19, sem defeito; os quatro pontos de atenção que ela
deixou para a 5.10, a 6.3 e a 6.4 estão no `deferred-work.md`.
...
Épicas 1 a 4 fechadas; Estória 5.1 (máquina de estados do Pedido) em main, done.
