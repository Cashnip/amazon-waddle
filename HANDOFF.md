...
A Épica 6 está quase fechada: 6.1 a 6.6 em main, em review — Meus pedidos,
Detalhe, cancelamento pelo Comprador, painel do Administrador, o pagamento
aprovado sobre Pedido cancelado visível a ele, e a simulação de entrega.
Próximo passo: Estória 6.7 (A forma de exibição dos sete Status).
```
