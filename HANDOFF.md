...
`bmad-build` na **Estória 6.3** (Cancelamento pelo Comprador) — a Épica 5 está inteira em `main`, e a 6.1 (`48f6723`) e a 6.2 (`5f618db`) também. A 5.11 está em `main` (`8a3dfd0`), a 5.10 em `main` (`22500bf`), a 5.9 em `main` (`577a6aa`), a 5.8 em `main` (`e421de8`), a 5.7
em `main` (`7cd26ac`), a 5.6 em `main` (`9174f88`), a 5.5 em `main` (`f3cc0ff`), a 5.4 em `main` (`6e5984f`), a 5.3 em `main` (`dbcb2b8`) e a 5.2 em
`main` (`400861b`), as dez em `review` no `sprint-status.yaml`, mais a 6.1 e a 6.2: falta a leitura humana
(`bmad-checkpoint-preview`) e o passeio da seção Verification das specs — 360 e 1440 px, só pelo
teclado —, que ninguém fez. **Nenhuma tela da Épica 5 nem da 6 foi aberta num navegador.** Da 6.2, o passeio é levar um total de `,00` de `PAGO` até "Entregue" pela simulação vendo a linha do tempo ganhar cada transição sem recarregar, a frase de entregue aparecer junto dos valores, o filete entre os marcadores alinhado, e nada rolando na horizontal a 360 px. Da 6.1, o passeio
