...
A Épica 6 começou: 6.1 (Meus pedidos — envelope do AD-18, paginação e a data
vinda do histórico) em main, em review.
Próximo passo: Estória 6.2 (Detalhe do Pedido).
```
